...
if __name__ == '__main__':
    ...
    filter_length = [3]   #See unet model. Filter length used.
    n_filters = [64]     #See unet model. Arranging this so that total number of model parameters <~ 10M, otherwise OOM problems
    lmbda = [0]           #See unet model. L2 Weight regularization strength (lambda).
